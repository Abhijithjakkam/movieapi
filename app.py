...
def get_movie_details(name):
    ...
    response = requests.get(f'http://www.omdbapi.com/?t={name}&apikey=4a9abcb1')
...
def get_top_movies():
    ...
    while len(movie_list) < 50:
        ...
        response = requests.get(f'http://www.omdbapi.com/?s=*&type=movie&page={page}&apikey=4a9abcb1')
